...
stdenv.mkDerivation (finalAttrs: {
  ...
  cmakeFlags = [
    ...
    (lib.cmakeBool "CATALYST_BUILD_TESTING" finalAttrs.finalPackage.doInstallCheck)
  ];
  ...
  nativeInstallCheckInputs = [ ctestCheckHook ] ++ lib.optional mpiSupport mpiCheckPhaseHook;
